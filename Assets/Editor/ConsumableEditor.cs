...
/// <summary>
/// Custom editor for the Consumable Template scriptable object.
/// Allows editing strategies without needing to create a new scriptable object for each one.
/// </summary>
[CustomEditor(typeof(ConsumableTemplate))]
public class ConsumableEditor : UnityEditor.Editor
{
    //DATA
    //Order must match in these lists
    private List<Type> managedTypes = new List<Type>() {  typeof(AbilityEffect) };
    private List<string> propertyNames = new List<string>() { "OnUseEffects" };
